...
Your smart contract will use ether management functions to implement various requirements
    ...
    */
    function withdraw(uint amount, address payable recipient) public {
        ...
        */
        ...
        /*
        Call the `contractBalance` variable and set it equal to the balance of
        the contract by using `address(this).balance` to reflect the new balance 
        of the contract.
        */
